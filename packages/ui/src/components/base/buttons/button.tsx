...
export const styles = sortCx({
    ...
    sizes: {
        sm: {
            root: [
                "gap-1 rounded-md px-3 py-2 text-sm font-semibold before:rounded-[calc(var(--radius-md)-1px)] data-icon-only:p-2",
        ...
        md: {
            root: [
                "gap-1 rounded-md px-3.5 py-2.5 text-sm font-semibold before:rounded-[calc(var(--radius-md)-1px)] data-icon-only:p-2.5",
                "in-data-input-wrapper:gap-1.5 in-data-input-wrapper:px-4 in-data-input-wrapper:text-md in-data-input-wrapper:data-icon-only:p-3",
            ].join(" "),
            linkRoot: "gap-1",
        },
        lg: {
            root: "gap-1.5 rounded-md px-4 py-2.5 text-md font-semibold before:rounded-[calc(var(--radius-md)-1px)] data-icon-only:p-3",
            linkRoot: "gap-1.5",
        },
        xl: {
            root: "gap-1.5 rounded-md px-4.5 py-3 text-md font-semibold before:rounded-[calc(var(--radius-md)-1px)] data-icon-only:p-3.5",
            linkRoot: "gap-1.5",
        },
    },
