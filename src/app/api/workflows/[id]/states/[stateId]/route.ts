...
import { updateState, deleteState } from '@/lib/workflows'
...
// PATCH /api/workflows/[id]/states/[stateId] — update a state
...
// DELETE /api/workflows/[id]/states/[stateId] — delete a state
