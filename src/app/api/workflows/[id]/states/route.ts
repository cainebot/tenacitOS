...
import { getWorkflowStates, createState } from '@/lib/workflows'
import type { StateCategory } from '@/types/workflow'
...
// GET /api/workflows/[id]/states — return all states for a workflow
...
// POST /api/workflows/[id]/states — create a new state
