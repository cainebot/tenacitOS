...
export async function PATCH(request: NextRequest, { params }: RouteParams) {
  ...
  const { name, description, card_type_filter, state_filter, workflow_id, project_lead_agent_id } = body as {
    name?: string
    description?: string
  ...
  if (!name && description === undefined && !card_type_filter && !state_filter && !workflow_id && project_lead_agent_id === undefined) {
