/**
 * HTML-based chat bubble that floats over Phaser sprites.
 * Extracted from Agent Town: components/game/entities/ChatBubble.ts
 */
...
export class ChatBubble {
  ...
  constructor(scene: Phaser.Scene) {
    ...
    this.el.style.cssText = `
      ...
      color: #1a1a2e;
      font-family: var(--pixel-font-chat, monospace);
      font-size: 13px;
      line-height: 1.5;
